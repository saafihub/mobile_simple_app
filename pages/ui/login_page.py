...
class LoginPage(BasePage):
    ...
    def get_sl_version(self):
        ...
        # return self.driver.find_element(*CreateLogin.SL_app_version).text
    ...
    def click_cancel_image(self):
        ...
        # return self.driver.find_element(*CreateLogin.Cancel_image_button).click()
    ...
    def all_btns_landing(self):
        # return self.driver.find_elements(*CreateLogin.get_all_buttons)
